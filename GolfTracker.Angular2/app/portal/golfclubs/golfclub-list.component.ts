...
import { PortalGolfCoursesForGolfClubComponent } from './golfcourses-for-golfclub.component';
...
@Component({
    ...
    directives: [NgClass, PortalGolfCoursesForGolfClubComponent, ManageCourseComponent, ManageGolfClubComponent]
})
export class PortalGolfClubListComponent implements OnInit {
