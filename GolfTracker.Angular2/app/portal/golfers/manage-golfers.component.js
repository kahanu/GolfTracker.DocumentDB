...
var PortalManageGolfersComponent = (function () {
    function PortalManageGolfersComponent(_golferService, _golfClubService, _titleService, _pubsub) {
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getGolfers();
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.processGolferSubscription = function (golfer) {
    ...
    **********************************************************************************************/
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.getGolfers = function () {
        var _this = this;
        this.golfers = [];
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.showAddGolferForm = function () {
        this.hideAllForms();
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.updateGolfer = function (golfer) {
        this.hideAllForms();
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.deleteGolfer = function (golfer, idx) {
        var _this = this;
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.onManageGolferClose = function () {
        this.hideAllForms();
        this.shortTable = false;
    };
    /**********************************************************************************************
    ...
    **********************************************************************************************/
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.showRoundForm = function (golfer, idx) {
        this.hideAllForms();
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.viewRounds = function (golfer) {
        this.hideAllForms();
        this.golfer = golfer;
        this.shortTable = true;
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.onCloseAddRoundForm = function () {
        this.hideAllForms();
        this.shortTable = false;
    };
    ///<author>
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.onCloseViewRounds = function () {
        this.hideAllForms();
        this.shortTable = false;
    };
    /**********************************************************************************************
    ...
    **********************************************************************************************/
    ...
    ///</summary>
    PortalManageGolfersComponent.prototype.hideAllForms = function () {
        this.golferFormIsVisible = false;
        this.roundFormIsVisible = false;
        this.viewRoundsIsVisible = false;
    };
    PortalManageGolfersComponent = __decorate([
        core_1.Component({
            selector: "manage-golfers",
            templateUrl: "app/portal/golfers/manage-golfers.component.html",
    ...
    return PortalManageGolfersComponent;
}());
exports.PortalManageGolfersComponent = PortalManageGolfersComponent;
